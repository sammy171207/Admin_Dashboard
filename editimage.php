...
if(isset($Email)){
  ...
  $info = "SELECT student_id, full_name, gender, dob, email, student_number, parent_number, course, c_name, batch_timing, photofile, city FROM student_admission WHERE email = '$mb'";
                        ...
                        <span class="menu1">Edit</span>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-8">
                                    ...
                                    <div class="card shadow-sm">
                                        <div class="card-header bg-transparent border-0">
                                            <h3 class="mb-0"><i class="far fa-clone pr-1"></i>EDIT PROFILE PICTURE</h3>
                                            <br>
                                                            ...
                                                            <div class="card-body">
                                                                ...
                                                                <form class="forms-sample" method="post" enctype="multipart/form-data">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="file" name="uploadimg"  title="<?php echo $dp  ?>" readonly style="width:200px" class="form-control" accept="image/png, image/jpeg">
                                                                    </div>


                                                                    <center><button type="submit"  values="Update" class="btn btn-primary mr-2" name="Update">UPDATE</button></center>
...
if (isset($_POST['Update']))
{
   ...
   $dob   =$_POST['dob'];
    ...
    $img_file_name =  $_FILES["uploadimg"]["name"];
    $img_temp_name =  $_FILES["uploadimg"]["tmp_name"];
    $img_folder = "stuimg/$img_file_name";

    $imgFileType = strtolower(pathinfo($img_folder,PATHINFO_EXTENSION));

    move_uploaded_file($img_temp_name,$img_folder); 

 $query="UPDATE student_admission SET photofile='$img_file_name' WHERE student_id='$stdid'";
