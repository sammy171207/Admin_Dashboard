...
<div class="student-profile py-4">
  ...
  <div >
                        ...
                        <span class="menu1">JOB CALL</span>
                        </div>
    <div class="row">
      <div class="col-lg-4">
        ...
        <div class="card shadow-sm">
          ...
          <div class="card-body pt-0">
            ...
            <tr>
            <td>&nbsp;<i class="fa fa-inr"></i>&nbsp;&nbsp;&nbsp;&nbsp;<a href="payment.php?email=<?php echo $mb ?>">FEES PAYMENT</a></td>
            </tr>
             <tr>
               <td>&nbsp;<i class="fa fa-inr"></i>&nbsp;&nbsp;&nbsp;&nbsp;<a href="payment_details.php?email=<?php echo $mb ?>">FEES DETAILS</a></td>
                                                </tr>
...
<a href="next.php" class="btn btn-light preri">previous</a>
